            ...
            <div class="col-lg-3">
              <div class="card mb-3 text-center">
                ...
                <div class="card-body">
                  ...
                  <form action="changeStatusEmployee.php" method="POST">
                    <input type="hidden" id="staffid" name="empcod" value=" <?php echo $_SESSION['uid']; ?>" />
                      <?php if (getStatus()=='Online') echo "<input type='submit' class='btn btn-success myBtn' name='btnSta' value='Online'>"; else echo"<input type='submit' class='btn btn-danger myBtn' name='btnSta' value='Offline'>" ?>
                  </form>
                </div>
              </div>
            </div>
