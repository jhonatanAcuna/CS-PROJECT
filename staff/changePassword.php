                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <form action="editPassword.php" method="POST" class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
                                    <div class="input-group">

                                        <li class="form-control"><?php echo $_SESSION['username']?></li>
                                        <input type="hidden" id="staffid" name="empcod" value=" <?php echo $_SESSION['uid']; ?>" />
                                        <input type="password" required="required" name="password" class="form-control" placeholder="Nueva Contraseña" aria-label="Add" aria-describedby="basic-addon2">
                                        <!-- contraseña-->
                                        <div class="input-group-append">
                                            <button type="submit" name="editPass" class="btn btn-primary">
                                                Enviar
                                            </button>
                                        </div>
                                    </div>
