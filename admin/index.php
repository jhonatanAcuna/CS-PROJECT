...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <button class="btn btn-link btn-sm text-white order-1 order-sm-0" id="sidebarToggle" href="#"><!-- boton de menu-->
      ...
      <ul class="navbar-nav ml-auto ml-md-0">
        <li class="nav-item dropdown no-arrow">
          <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="fas fa-user-circle fa-fw"></i> <!-- icono de sesion-->
          </a>
        </li>
      </ul>
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item"> <!-- por implementar -->
          <a class="nav-link" href="sales.php">
            <i class="fas fa-fw fa-chart-area"></i>
            <span>Ventas</span></a>
        </li>

        <li class="nav-item"> <!-- empleados -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  <table id="tblCurrentOrder" table class="table table-bordered" width="100%" cellspacing="0">
                    ...
                    <tbody id="tblBodyCurrentOrder"> <!-- llamada  a script-->
