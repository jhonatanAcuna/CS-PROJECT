...
<body id="page-top">
	...
	<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
		...
		<a class="navbar-brand mr-1" href="index.php">Restaurante | Categoria</a>
							...
							while ($catRow = $catResult->fetch_array(MYSQLI_ASSOC)) { ?>
								...
								<div class="card mb-3 border-primary">
									<div class="card-header">
										...
										<button class="btn btn-primary btn-sm float-right" data-toggle="modal" data-target="#addProdModal" data-category="<?php echo $catRow["catnom"]; ?>" data-catid="<?php echo $catRow["catcod"]; ?>">Agregar</button>
										<!--agrega producto-->
